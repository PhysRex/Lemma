...
function stopAll() {
  ...
  clearInterval(soundID); // clears soundID
}

function settingsReset () {  
  // Reset time
  document.querySelector("#timeIn").value = "1";

  // Reset max points
  document.querySelector("#pointsIn").value = "5";

  // Reset volume
  document.querySelector("#volIn").value = "50";
...
function plays(time) {
  ...
  // var mp3 = document.getElementsByClassName("audioTest");
  mp3.setAttribute('src', './audio/beep.mp3');
  mp3.load();
...
function randomArr(length, maxNum) {
  // return array of length *length* of random numbers from [0, maxNum]
